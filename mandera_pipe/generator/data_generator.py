...
def run():
    ...
    try:
        ...
        all_customer_ids = db[MONGO_COLLECTIONS["customers"]].distinct(
            "customer_id")
        all_product_ids = db[MONGO_COLLECTIONS["products"]
                             ].distinct("product_id")

        # Generate and insert orders
        orders = faker_orders.generate(
            all_customer_ids, all_product_ids, batch_id)
